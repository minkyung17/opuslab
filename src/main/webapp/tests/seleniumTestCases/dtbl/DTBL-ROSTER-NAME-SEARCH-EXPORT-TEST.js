...
exports.runDTBLRosterNameSearchExportTest = async (caller, environment) => {
	// initialize values
	var passFail = "";
	desiredFileHeader = "Name";
	const desiredName = "Abdelmalak";
    ...
    const testModule = "DTBL-ROSTER-NAME-SEARCH-EXPORT";
    ...
    try
    {
		...
		if((pageDidLoad) && (dataExists))
		{
			...
			// enter desired name into name search field
			await activeAppointmentsPage.searchDesiredName(loggingPrefix, driver, desiredName, fileName);
			...
			//////////////////////////////////////////////////////////////////
			// ONLY DESIRED NAME EXISTS IN EXPORT FILE
			//////////////////////////////////////////////////////////////////
			
			// check if export file only has desired name for each record
			const exportFileContainsOnlyDesiredValue = await dtblLib.exportFileContainsOnlyDesiredValue(loggingPrefix, driver, desiredFileHeader, desiredName, fileName);
