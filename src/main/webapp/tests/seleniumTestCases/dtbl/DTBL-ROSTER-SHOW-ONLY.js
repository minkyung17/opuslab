runDTBLRosterShowOnly = (caller, ottoEnvironment) =>
{
	const dtblLib = require("./DTBL-LIB");
    const dtblRosterShowOnlyTest = require("./DTBL-ROSTER-SHOW-ONLY-TEST");
    
    
	///////////////////////////////////////////////////
	// ALL ROLES, ALL TESTS FOR DTBL-ROSTER-SHOW-ONLY
	///////////////////////////////////////////////////
	
	// define all roles
	var allRolesForDTBL_Roster_Show_Only =
	[
		"oa"
	];
	
	// define all tests
	var allTestsForDTBL_Roster_Show_Only =
	[
		"ApptsActive"
	];
	...
	logProperUsage = () =>
	{
		dtblLib.logThis("usage:   " + "node (relative dir/)DTBL-ROSTER-SHOW-ONLY-CLI.js [env] [browser --optional] [headed --optional]");
		dtblLib.logThis("example: " + "node dtbl/DTBL-ROSTER-SHOW-ONLY-CLI.js TEST chrome headed");
	}
	logProperUsage();
	...
	takeMyDTBLRosterShowOnlyOrder = async () =>
	{	
        await dtblRosterShowOnlyTest.runDTBLRosterShowOnlyTest(caller, argsEnvironment);
	}
	...
	// run tests
	dtblLib.executeRunOrder(runType, allRolesForDTBL_Roster_Show_Only, allTestsForDTBL_Roster_Show_Only, "apo", "ProfileAppointmentSet", takeMyDTBLRosterShowOnlyOrder, overallStartTime);
}