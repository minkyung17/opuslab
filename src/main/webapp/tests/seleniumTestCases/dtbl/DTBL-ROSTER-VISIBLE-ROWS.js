runDTBLRosterVisibleRows = (caller, ottoEnvironment) =>
{
	const dtblLib = require("./DTBL-LIB");
    const dtblRosterVisibleRowsTest = require("./DTBL-ROSTER-VISIBLE-ROWS-TEST");
    
    
	///////////////////////////////////////////////////
	// ALL ROLES, ALL TESTS FOR DTBL-ROSTER-VISIBLE-ROWS
	///////////////////////////////////////////////////
	
	// define all roles
	var allRolesForDTBL_Roster_Visible_Rows =
	[
		"oa"
	];
	
	// define all tests
	var allTestsForDTBL_Roster_Visible_Rows =
	[
		"ApptsActive"
	];
	...
	logProperUsage = () =>
	{
		dtblLib.logThis("usage:   " + "node (relative dir/)DTBL-ROSTER-VISIBLE-ROWS-CLI.js [env] [browser --optional] [headed --optional]");
		dtblLib.logThis("example: " + "node dtbl/DTBL-ROSTER-VISIBLE-ROWS-CLI.js TEST chrome headed");
	}
	logProperUsage();
	...
	takeMyDTBLRosterVisibleRowsOrder = async () =>
	{	
        await dtblRosterVisibleRowsTest.runDTBLRosterVisibleRowsTest(caller, argsEnvironment);
	}
	...
	// run tests
	dtblLib.executeRunOrder(runType, allRolesForDTBL_Roster_Visible_Rows, allTestsForDTBL_Roster_Visible_Rows, "apo", "ProfileAppointmentSet", takeMyDTBLRosterVisibleRowsOrder, overallStartTime);
}