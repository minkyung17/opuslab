runProfileEndAppointmentSet = (caller, ottoEnvironment) =>
{
	const profileLib = require("./PROFILE-LIB");
    const profileEndAppointmentSetTest = require("./PROFILE-END-APPT-SET-TEST");
    
    
	///////////////////////////////////////////////////
	// ALL ROLES, ALL TESTS FOR PROFILE-END-APPT-SET
	///////////////////////////////////////////////////
	
	// define all roles
	var allRolesForProfile_End_Appointment_Set =
	[
		"apo"	
	];
	
	// define all tests
	var allTestsForProfile_End_Appointment_Set =
	[
	...
	logProperUsage = () =>
	{
		profileLib.logThis("usage:   " + "node (relative dir/)PROFILE-END-APPT-SET-CLI.js [env] [browser --optional] [headed --optional]");
		profileLib.logThis("example: " + "node profile/PROFILE-END-APPT-SET-CLI.js TEST chrome headed");
	}
	logProperUsage();
	...
	// run tests
	profileLib.executeRunOrder(runType, allRolesForProfile_End_Appointment_Set, allTestsForProfile_End_Appointment_Set, "apo", "ProfileAppointmentSet", takeMyProfileEndAppointmentSetOrder, overallStartTime);
}