...
import ExcellenceReviewClockSummary from '../../../opus-logic/datatables/classes/ExcellenceReviewClockSummary';
import {ShowIf} from '../../common/components/elements/DisplayIf.jsx';
import FilteredView from '../components/FilteredView.jsx';

/******************************************************************************
 *
 * @desc - Handles Excellence Review Clock Summary via dataTableConfiguration file
 *
 ******************************************************************************/
export default class ExcellenceReviewClockSummaryComponent extends DataTableComponent {
  /*
   *
  ...
  defaultViewConfigName = 'excellenceReviewClockSummary'; //Matches name in AllConstants.js
  tableClassName = 'excellenceReviewClockSummary';

  /**
  * Set up the Logic class w/ passed in props immediately
  *
  **/
  Logic = new ExcellenceReviewClockSummary(this.props);
  exportToExcel = true;
  selectedRows = {};
