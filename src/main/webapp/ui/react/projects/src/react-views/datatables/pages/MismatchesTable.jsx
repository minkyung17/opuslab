...
import Mismatches from "../../../opus-logic/datatables/classes/Mismatches";
...
import {searchCriteria} from "../../../opus-logic/datatables/constants/MismatchesConstants";
import FilteredView from "../components/FilteredView.jsx";

/******************************************************************************
 *
 * @desc - Handles Mismatches via dataTableConfiguration file
 *
 ******************************************************************************/
export default class MismatchesTableComponent extends DataTableComponent {
  ...
  *
  **/
    Logic = new Mismatches(this.props);
   ...
   **/
    state = {
        ...
        specialShowOnlyFilter: "Mismatch"
    };
