...
import OpusHiddenMismatches from "../../../opus-logic/datatables/classes/OpusHiddenMismatches";
...
import {searchCriteria} from "../../../opus-logic/datatables/constants/OpusHiddenMismatchesConstants";
import FilteredView from "../components/FilteredView.jsx";

/******************************************************************************
 *
 * @desc - Handles Opus Hidden Mismatches via dataTableConfiguration file
 *
 ******************************************************************************/
export default class OpusHiddenMismatchesTableComponent extends DataTableComponent {
  ...
  *
  **/
    Logic = new OpusHiddenMismatches(this.props);
   ...
   **/
    state = {
        ...
        specialShowOnlyFilter: "opusHidden"
    };
   ...
   **/
    setUpPage() {
        ...
        this.attachOnClickForUnhideRow(dataTableConfiguration);
    }

    attachOnClickForUnhideRow(dataTableConfiguration) {
        let dtConfig = dataTableConfiguration.columnConfiguration;
      // Unhide column on click event
        if(dtConfig.unhideRow) {
            dtConfig.unhideRow.onClick = (evt, rowData) => this.unhideRow("N", evt, rowData);
        }
        return dataTableConfiguration;
    }

    unhideRow = async (isHiddenFlag, evt, {rowData} = {}) => {
        let originalData = rowData.originalData;

        let hidePromise = this.Logic.unhideRow(originalData, isHiddenFlag);
