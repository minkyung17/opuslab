...
import HiddenMismatches from "../../../opus-logic/datatables/classes/HiddenMismatches";
...
import {searchCriteria} from "../../../opus-logic/datatables/constants/HiddenMismatchesConstants";
import FilteredView from "../components/FilteredView.jsx";

/******************************************************************************
 *
 * @desc - Handles Hidden Mismatches via dataTableConfiguration file
 *
 ******************************************************************************/
export default class HiddenMismatchesTableComponent extends DataTableComponent {
  ...
  *
  **/
    Logic = new HiddenMismatches(this.props);
