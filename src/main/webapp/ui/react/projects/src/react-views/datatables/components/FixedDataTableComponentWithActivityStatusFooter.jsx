...
import {tableOptions, defaultFixedDataTableState} from '../constants/DatatableConstants.js';
 ...
 *
 ******************************************************************************/
export default class FixedDataTableComponentWithActivityStatusFooter extends React.Component {
  ...
  **/
  ...
  getAllColumns({columnKeys = [], columnViewConfiguration, columnConfiguration,
    ...
    return columns;
        ...
        /**
   *
   * @desc - Renders the footer you see below the datatable
   * @returns {JSX} - jsx for table buttons
   *
   **/
        getFooterRow = () => {        
  
          let {props: {dataTableConfiguration}} = this;
          let {assignedPercent, satisfiedPercent, overduePercent} = dataTableConfiguration.activityStatusData;

          return (
            <div style={{paddingTop: "20px", fontSize: "17px"}}>
              <div className="light-yellow ">       
                <b>Activity Status Summary </b>&nbsp;&nbsp;| &nbsp;&nbsp; Assigned : {assignedPercent} &nbsp;&nbsp;| &nbsp;&nbsp; Satisfied : {satisfiedPercent} &nbsp;&nbsp;| &nbsp;&nbsp; Overdue/Expired : <img src="../images/warning.png"/> {overduePercent}
              </div> 
            </div> 
            );
          }
  ...
  render() {
    ...
    let footerRow = this.getFooterRow();
