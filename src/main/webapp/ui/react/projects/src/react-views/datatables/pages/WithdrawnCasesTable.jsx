...
import WithdrawnCases from '../../../opus-logic/datatables/classes/WithdrawnCases';
 ...
 *
 ******************************************************************************/
export default class WithdrawnCasesTableComponent extends CasesTableComponent {
  ...
  *
  **/
  Logic = new WithdrawnCases(this.props);
  ...
  resetDataTableConfiguration(){
    ...
    dataTableConfiguration = this.attachOnClickForDeleteColumn(dataTableConfiguration);
