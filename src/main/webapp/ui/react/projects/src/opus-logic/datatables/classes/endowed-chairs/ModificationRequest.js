...
export default class ModificationRequest extends EndowedChairs {
  ...
  *
  **/
    defaultConfigName = "modificationRequest";
...
**/
  getDataUrlParameters(dataTableConfiguration = this.dataTableConfiguration) {
    ...
    return {endowedChairStatusId:3,grouperPathText, access_token, loggedInOpusId: adminData.adminOpusId, opusScreenName: pageName};
}
