...
/******************************************************************************
 *
 * @desc - Active Endowed Chairs
 *
 ******************************************************************************/

export default class DisestablishedEndowedChairs extends EndowedChairs {
  ...
  *
  **/
    defaultConfigName = "disestablishedEndowedChairs";
   ...
   **/
      getDataUrlParameters(dataTableConfiguration = this.dataTableConfiguration) {
        ...
        return {endowedChairStatusId:4,grouperPathText, access_token, loggedInOpusId: adminData.adminOpusId, opusScreenName: pageName};
    }
