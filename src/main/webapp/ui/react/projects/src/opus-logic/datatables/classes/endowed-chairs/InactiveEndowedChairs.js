...
export default class InactiveEndowedChairs extends EndowedChairs {
  ...
  *
  **/
    defaultConfigName = "inactiveEndowedChairs";
   ...
   **/
      getDataUrlParameters(dataTableConfiguration = this.dataTableConfiguration) {
        ...
        return {endowedChairStatusId:5,grouperPathText, access_token, loggedInOpusId: adminData.adminOpusId, opusScreenName: pageName};
    }
