...
export const disestablishedEndowedChairsConfig = {
  ...
  excelFileName: 'Disestablished.csv',
  pageName: 'DisestablishedEndowedChairs',
    ...
    filters: {
      dataColumnFilters:{
        ...
        formattedColumnOptions: [
          ...
          {visible: true, name: "dateDisestablished", displayName: "Date Disestablished"},
  ...
  "area", "organizationName", "dateEstablished", "dateDisestablished","endowedChairType","endowedChairTerm",
...
//   omitUIColumns: ["comments"],
  ...
  columnConfiguration: {
    ...
    dateDisestablished: {
        name: "dateDisestablished",
        displayName: "Date Disestablished",
        viewType: dataViewTypes.displayByKey,
        pathsInAPI: {
            appointment: {
                value: "dateDisestablished",
                displayText: "dateDisestablished"
            }
        },
        transformDate: {
            from: "MM/DD/YYYY",
            to: "YYYY/MM/DD",
            pathToGetValue: "dateDisestablished",
            pathToSetValue: "dateDisestablished"
        },
        saveOriginalValueByKey: "displayValue_dateDisestablished",
        displayKey: "displayValue_dateDisestablished",
        width: 200,
        visible: true,
        sortable: true,
        dynamicFilterSearch: true,
        descriptionText: descriptions.dateDisestablished
    },
    endowedChairType: {
...
export const config = createConfigFromTemplate(disestablishedEndowedChairsConfig);
