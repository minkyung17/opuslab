 ...
 *
*******************************************************************************/
export const activeCasesConfig = {
    ...
    excelFileName: "ActiveCases.csv",
    caseSummaryLink: "/opusWeb/ui/admin/case-summary.shtml?",
    deleteCasesUrl: "/restServices/rest/activecase/deleteACase?",
    caseType: "activeCase",
    pageName: "Active",
    csvPageName: "Active",
  ...
  //Columns will appear in array order shown here
    ...
    "currentStep", "proposedTitleCode", "proposedTitleName", "proposedSeries", "proposedRank", "proposedStep",
    "proposedAppointmentPctTime", "proposedEffectiveDate", "caseLocation", "opusCreateDt", "interfolioCreateDt",
    "apoAnalyst", "interfolioLink", "bycUserId", "appointmentId", "caseId", "bycPacketId", "delete"],
...
export const config = createConfigFromTemplate(activeCasesConfig);
