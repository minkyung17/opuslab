...
const opusMismatchesConfig = {
    ...
    hideUrl: "/restServices/rest/reports/updateOpusComparisonVisibility",
    // columnFilterKey: "eligibleFilterMap",
    dataRowName: "opusComparisonList",
    excelFileName: "OpusMismatches.csv",
  ...
  //Columns will appear in array order shown here
    columnKeys: ["caseExist", "hideRow", "emplId", "opusId", "name", "primaryApptId",
...
export const config = createConfigFromTemplate(opusMismatchesConfig);
