...
const mismatchesConfig = {
    ...
    unhideUrl: "/restServices/rest/ucpath/updateUcPathComparisonVisibility",
    // columnFilterKey: "eligibleFilterMap",
    dataRowName: "ucPathComparisonList",
    excelFileName: "HiddenMismatches.csv",
  ...
  //Columns will appear in array order shown here
    columnKeys: ["caseExist", "unhideRow", "emplId", "opusId", "name", "opusApptId",
