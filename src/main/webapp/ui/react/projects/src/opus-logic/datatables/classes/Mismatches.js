...
import {searchCriteria} from "../constants/MismatchesConstants";
import * as util from "../../common/helpers/";

export default class Mismatches extends DataTable {
  //Class variables
    rowData = [];
  ...
  *
  **/
    defaultConfigName = "mismatchesReport";
 ...
 **/
   ...
   **/
    async hideRow(rowData, hideFlag) {
        ...
        hideUrl = hideUrl+"&appointmentId="+rowData.opusApptId+"&emplId="+rowData.emplId
                +"&emplRcd="+rowData.emplRcd+"&isHidden="+hideFlag+"&opusScreenName=Mismatch&grouperPathText="+grouperPathText;
        console.log(hideUrl);
