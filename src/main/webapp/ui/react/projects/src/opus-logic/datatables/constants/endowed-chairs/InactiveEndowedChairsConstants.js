...
export const inactiveEndowedChairsConfig = {
  ...
  excelFileName: 'InactiveEndowedChairs.csv',
  pageName: 'InactiveEndowedChairs',
...
export const config = createConfigFromTemplate(inactiveEndowedChairsConfig);
