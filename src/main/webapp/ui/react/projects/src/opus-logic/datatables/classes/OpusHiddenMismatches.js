...
import {searchCriteria} from "../constants/OpusHiddenMismatchesConstants";
import * as util from "../../common/helpers/";

export default class OpusHiddenMismatches extends DataTable {
  //Class variables
    rowData = [];
 ...
 **/
   ...
   **/
    async unhideRow(rowData, unhideFlag) {
        ...
        unhideUrl = unhideUrl+"&appointmentId="+rowData.primaryApptId+"&emplId="+rowData.emplId
                +"&additionalApptId="+rowData.additionalApptId+"&isHidden="+unhideFlag+"&opusScreenName=opusHidden&grouperPathText="+grouperPathText;
