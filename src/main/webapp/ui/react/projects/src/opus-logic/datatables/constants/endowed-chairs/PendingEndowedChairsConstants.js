...
/**
 *
 * @desc - Configuration constant for Pending Endowed Chairs Page
 *
**/
export const pendingEndowedChairsConfig = {
  grouperPathText: 'endowed_chair_view',
  exportToExcelBaseUrl: '/restServices/rest/ec/downloadEndowedChairsCSV',
  endowedChairStatusId: 2,
  ...
  excelFileName: 'PendingEndowedChairs.csv',
  pageName: 'PendingEndowedChairs',
...
export const config = createConfigFromTemplate(pendingEndowedChairsConfig);
