 ...
 *
**/
export const activeEndowedChairsConfig = {
  grouperPathText: 'endowed_chair_view',
  exportToExcelBaseUrl: '/restServices/rest/ec/downloadEndowedChairsCSV',
  exportAllPagesToExcelBaseUrl: '/restServices/rest/ec/downloadEndowedChairsCSV',
  ...
  excelFileName: 'ActiveEndowedChairs.csv',
  pageName: 'ActiveEndowedChairs',
  ...
  columnKeys: ["activeCase", "endowedChairId", "endowedChairName", "school", "division", "department",
  ...
  notSortable: ["activeCase", "endowedChairId", "designation", "opusId", "comments"],
  omitUIColumns: ["activeCase"],
  invalidChangeColumnsOptions: ['activeCase', 'endowedChairName'],
  ...
  columnConfiguration: {
    activeCase: {
        ...
        imageTitleHoverText: descriptions.ecActiveCases,
...
export const config = createConfigFromTemplate(activeEndowedChairsConfig);
