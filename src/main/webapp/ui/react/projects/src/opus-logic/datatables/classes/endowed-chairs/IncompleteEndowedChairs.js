...
/******************************************************************************
 *
 * @desc - Incomplete Endowed Chairs
 *
 ******************************************************************************/

export default class IncompleteEndowedChairs extends EndowedChairs {
  ...
  *
  **/
    defaultConfigName = "incompleteEndowedChairs";
   ...
   **/
      getDataUrlParameters(dataTableConfiguration = this.dataTableConfiguration) {
        ...
        return {endowedChairStatusId:6,grouperPathText, access_token, loggedInOpusId: adminData.adminOpusId, opusScreenName: pageName};
    }
