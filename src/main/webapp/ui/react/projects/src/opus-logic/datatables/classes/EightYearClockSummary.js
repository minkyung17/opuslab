...
/******************************************************************************
 *
 * @desc - Eight Year Clock Summary
 *
 ******************************************************************************/

export default class EightYearClockSummary extends DataTable {
  ...
  *
  **/
  defaultConfigName = 'eightYearClockSummary';
  ...
  /**
   *
   * @desc - Come here to do special stuff to EYC Summary table data
