...
export const modificationRequestConfig = {
  ...
  excelFileName: 'ModificationRequest.csv',
  pageName: 'ModificationEndowedChairs',
...
export const config = createConfigFromTemplate(modificationRequestConfig);
